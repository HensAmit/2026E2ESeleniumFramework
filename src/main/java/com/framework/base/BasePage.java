...
public class BasePage {
    ...
    protected void click(By locator) {
        ...
        ExtentLogger.pass("Clicking on element: " + locator);
    }

    protected void type(By locator, String value) {
        logger.info("Typing '{}' into element: {}", value, locator);
        driver.findElement(locator).sendKeys(value);
        ExtentLogger.pass("Typing '" + value + "' into element: " + locator);
    }

    protected String getText(By locator) {
        String text = driver.findElement(locator).getText();
        logger.info("Getting text from element: {} → {}", locator, text);
        ExtentLogger.info("Getting text from element: " + locator + " → " + text);
        return text;
    }
    ...
    protected boolean isDisplayed(By locator) {
        ...
        ExtentLogger.info("Checking visibility of element: " + locator + " → " + status);
        return status;
    }
}